...
var client = new mercadopago_1.MercadoPagoConfig({ accessToken: process.env.MP_ACCESS_TOKEN });
var preference = new mercadopago_1.Preference(client);
exports.paymentRouter = (0, trpc_1.router)({
    ...
    createSession: trpc_1.privateProcedure
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var user, productIds, payload, products, filteredProducts, order, items1, items;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        order = _b.sent();
                        items1 = filteredProducts.map(function (prod) { return ({
                            id: prod.id,
                            title: prod.name,
                        ...
                        items = filteredProducts.map(function (prod) { return ({
                            title: prod.name,
                            quantity: 1,
                            unit_price: prod.price,
                            id: prod.id
                        ...
                        preference.create({
                            body: {
                                items: items,
                                back_urls: {
                                    success: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/thank-you?orderId=").concat(order.id),
                                    failure: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/cart"),
                                },
